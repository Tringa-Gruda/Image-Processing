...
# --- 5. Save the Model ---
model.save('skin_disease_detector_resnet50.h5')
print("\nModel saved as 'skin_disease_detector_resnet50.h5'.")
...
interactive_prediction('skin_disease_detector_resnet50.h5', img_size, class_names)
