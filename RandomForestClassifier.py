...
def interactive_prediction(rf_model, scaler, base_model, img_size, class_names):
    while True:
        ...
        try:
            ...
            confidence = np.max(rf_model.predict_proba(feature)) * 100
...
interactive_prediction(rf, scaler, base_model, img_size, class_names)
